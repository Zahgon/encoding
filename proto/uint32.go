...
func sizeOfUint32(p unsafe.Pointer, flags flags) int { _ = "STUB: not implemented"; return 0 }
...
func sizeOfFixed32(p unsafe.Pointer, flags flags) int { _ = "STUB: not implemented"; return 0 }
